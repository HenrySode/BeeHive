...
// RequestsPanel and CustomersPanel live in their own files: both need to
// subscribe to lib/liveActivity.ts so a request submitted on the public
// site appears without a page reload.
...
// UsersPanel and ProfilePanel live in their own files: unlike the panels
// above, they need local state (the user list and add-user drawer for
// UsersPanel, the edit toggle for ProfilePanel).
